...
| [`/ce-brainstorm`](./ce-brainstorm.md) | Define what something should become — collaborative dialogue, named gap lenses, infrastructure portfolio discovery, requirements-only unified plan |
